...
- 用户模块
  ...
  - 注册：`http://www.19marken.top:8089/api/v1/pri/user/register`
  ...
  - 登录：`http://www.19marken.top:8089/api/v1/pri/user/login`
  ...
  - 用户详细信息：`http://www.19marken.top:8089/api/v1/pri/user`
